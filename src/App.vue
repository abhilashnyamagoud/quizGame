<template>
  <div id="app" class="contain">
    ...
    <section v-else-if="uiState==='charactorChoosen'">
  ...
  <defs>
    ...
    <component :is="charactor"></component>
...
<div class="friendtalk"><h4> {{ questions[questionIndex].question }}</h4> </div>
...
export default{
  ...
  computed:{
    ...mapState(["uiState","questions","characterChoices","charactor","questionIndex"]),
  },
  methods:{
    pickCharacter(){
      // alert(this.characterinput)
      this.$store.commit('pickCharacter',this.characterinput)
      this.$store.commit('updateUiState','charactorChoosen')
    },
